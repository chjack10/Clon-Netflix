import { TopRatedMovie } from '../features/data/models/TopRatedMovie';

const dataLoading = async (): Promise<TopRatedMovie[] | null> => {
  const res: TopRatedMovie[] = [
    {
